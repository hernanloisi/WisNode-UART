If you want to use the chip serial port to control the WisNode-UART, please refer to the RAK477 sample program : https://github.com/RAKWireless/RAK477/tree/master/example
